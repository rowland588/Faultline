...
create policy "member projects insert" on public.projects for insert to authenticated with check (owner_id = (select auth.uid()) or public.is_project_member(id));
...
create policy "member projects delete" on public.projects for delete to authenticated using (public.is_project_owner(id) or (select public.is_super()));
...
create policy "project members manage" on public.project_members for all to authenticated using (public.is_project_owner(project_id) or (select public.is_super())) with check (public.is_project_owner(project_id) or (select public.is_super()));
drop policy if exists "own pace_ppm" on public.pace_ppm;
drop policy if exists "project pace_ppm" on public.pace_ppm;
create policy "project pace_ppm" on public.pace_ppm for all to authenticated using (owner_id = (select auth.uid()) or public.is_project_member(project_id)) with check (owner_id = (select auth.uid()) or public.is_project_member(project_id));
drop policy if exists "own pace_todos" on public.pace_todos;
drop policy if exists "project pace_todos" on public.pace_todos;
create policy "project pace_todos" on public.pace_todos for all to authenticated using (owner_id = (select auth.uid()) or public.is_project_member(project_id)) with check (owner_id = (select auth.uid()) or public.is_project_member(project_id));
drop policy if exists "own pace_wins" on public.pace_wins;
drop policy if exists "project pace_wins" on public.pace_wins;
create policy "project pace_wins" on public.pace_wins for all to authenticated using (owner_id = (select auth.uid()) or public.is_project_member(project_id)) with check (owner_id = (select auth.uid()) or public.is_project_member(project_id));
...
create policy "project pace_snapshots" on public.pace_snapshots for all to authenticated using (owner_id = (select auth.uid()) or public.is_project_member(project_id)) with check (owner_id = (select auth.uid()) or public.is_project_member(project_id));
